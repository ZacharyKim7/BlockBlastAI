...
class BlockBlastEnv(gym.Env):
    metadata = {
        "game_modes": ["BlockBlast"],
        "render_modes": ["ansi", "rgb_array", "human"],
        "render_fps": 10,
        "score_modes": ["BlockBlast"],
    }

    def __init__(self, game_mode="BlockBlast", render_mode=None, crash33=True, score_mode="BlockBlast"):
        # ASSERT
